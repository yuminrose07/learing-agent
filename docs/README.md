...
| 2026-05-31 | `2026-05-31-learning-mode-phase-1b-doc2-review-pass.md` | Phase 1B doc2 正式评审通过 |
| 2026-05-31 | `2026-05-31-learning-mode-phase-1b-close.md` | Phase 1B OrientationContext 实现与验收关闭 |
...
| `design-learning-mode-phase-1b-1e-skeleton.md` | 研学 Phase 1B-1E 骨架边界 | 正式评审通过 / 1B 已落地 |
| `design-learning-mode-phase-1b-orientation-context.md` | Phase 1B OrientationContext 详设 | 已落地 / 已验收 |
...
| `learning-mode-phase-1b-plan-checklist-2026-05-30.md` | Phase 1B 开工 checklist | 已关闭 / 2026-05-31 |
| `acceptance-report-learning-mode-phase-1b-2026-05-31.md` | Phase 1B 验收报告 | 已完成 |
