...
> 版本：v3.0
> 日期：2026-05-11
> 依赖文档：`docs/design/design-resilience-and-validation-design.md`、`docs/design/design-tool-execution-reliability-fix.md`
...
**位置**：`learning_agent/learning_agent/extensions/built_in.py` 中新增工厂函数。
...
- [ ] `docs/design/design-api-compatibility-tool-results-fix.md`：本文档 v3.0
- [ ] `docs/design/design-tool-execution-reliability-fix.md`：工具执行可靠性修复文档
